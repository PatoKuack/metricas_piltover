...
function LoginConfirmation(props) {
  return (
    <section className="flex flex-col text-center place-items-center">
      ...
      <button type="button" onClick={props.onclick} className="w-fit mx-auto p-4 bg-teal-600 flex flex-col justify-center place-items-center md:p-8 sm:p-6border border-solid border-current rounded-md shadow-md shadow-gray-300 hover:bg-teal-700 hover:shadow-gray-400 active:bg-teal-800 active:shadow-transparent">
