...
const Header = () => {
  ...
  return (
    <header className="z-10 fixed top-0 left-0 flex flex-row items-center w-full bg-gray-800 justify-between md:px-2 xl:px-4">
      ...
      <nav id="navBar" className={`absolute top-full py-4 px-2 w-[80vw] h-screen bg-gray-800 transition-[left] duration-500 cursor-pointer sm:relative sm:py-0 sm:px-0 sm:h-fit sm:w-fit sm:left-0 ${toggle ? 'left-0' : '-left-full'}`}>
